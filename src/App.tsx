...
Amplify.configure({
  API: {
    Events: {
      endpoint:
        "https://ms2gxy7sbzayrnmvyavlkj4au4.appsync-api.eu-central-1.amazonaws.com/event",
      region: "eu-central-1",
      defaultAuthMode: "apiKey",
      apiKey: "da2-jyxxdn5uyzbtnf7hzniuntde4a",
    },
  },
});
      ...
      <div className="">
        ...
        <div className="h-full  px-3 w-full bg-[#373c48] -mt-5 flex justify-center text-gray-400  overflow-x-hidden">
          <div className="w-full max-w-screen-md pt-10 pb-20 space-y-7">
            <div className="relative overflow-hidden rounded-2xl mt-8 bg-cover bg-center bg-[url('https://cdn.pixabay.com/photo/2017/09/03/12/14/hand-2710098_1280.jpg')]">
              <div className="py-10 md:py-16 bg-gradient-to-r from-[#46ace5b3] to-[#610acfb3] rounded-2xl flex flex-col relative z-[1]">
                ...
                <div className="flex justify-center">
                  <Link
                    href="https://donate.stripe.com/test_7sIcPG5m97ibbcI144"
                    target="_blank"
                    className="">
